<div class="wpstats_graph_wrapper wpstats_yearlydots wpstats_dots" data-years="<?php echo htmlspecialchars(json_encode($stats->years)) ?>" data-yearly="<?php echo htmlspecialchars(json_encode($stats->yearly)) ?>"
